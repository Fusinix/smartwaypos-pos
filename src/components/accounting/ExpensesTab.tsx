...
import { Plus, ArrowUpRight, Receipt, Tag, Repeat } from "lucide-react";
...
const ExpensesTab: React.FC<any> = ({ stats, analytics, expenses = [] }) => {
	...
	const spendingData = {
		labels:
			expenses.length > 0 ?
				Array.from(new Set(expenses.map((e: any) => e.category || "Other")))
			:	["No Expenses"],
		datasets: [
			{
				data:
					expenses.length > 0 ?
						Array.from(
							new Set(expenses.map((e: any) => e.category || "Other")),
						).map((cat) =>
							expenses
		...
		<div className="space-y-8 animate-in fade-in duration-500">
			...
			<div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
				...
				<div className="lg:col-span-2 space-y-6">
					<div className="bg-white border border-gray-100 rounded-xl p-8 h-full flex flex-col shadow-sm">
